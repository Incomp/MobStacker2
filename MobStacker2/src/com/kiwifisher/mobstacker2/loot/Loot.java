...
public class Loot {
    ...
    public Loot(Material material, int minimumQuantity, int maxQuantity, double dropChance, boolean addLooting) {

        this(material, (short) 0, minimumQuantity, maxQuantity, dropChance, addLooting);
    ...
    public Loot(Material material, short data, int minimumQuantity, int maxQuantity, double dropChance, boolean addLooting) {
